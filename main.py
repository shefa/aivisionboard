...
def main(page: ft.Page):
    ...
    def prompt(e):
        ...
        if USE_REFINER:
            image = refiner_lcm(body.image_src, dream_prompt.value+additional_prompts[selected_model])
            body.image_src = image
            print(dream_prompt.value, "refiner", image)
    ...
    def download_click(e):
        page.launch_url(body.image_src, web_window_name="_blank")
        height = page.height or page.window_height
        width = page.width or page.window_width
        print(height,width)
        page.update()
